...
class ConnectionsControllerTest < ActionController::TestCase
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post :create, connection: { description: @connection.description, frequency: @connection.frequency, login: @connection.login, name: @connection.name, password: @connection.password }
    end
  ...
  test "should update connection" do
    patch :update, id: @connection, connection: { description: @connection.description, frequency: @connection.frequency, login: @connection.login, name: @connection.name, password: @connection.password }
    assert_redirected_to connection_path(assigns(:connection))
  end
